    ...
    <header className="sticky top-0 z-30 border-b border-smooth-black/10 bg-clear-white/90 backdrop-blur">
      <nav className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-5 text-sm font-medium sm:gap-7">
          <a href="/#channels" className="hidden hover:text-real-blue sm:inline">
            Channels
          </a>
          <a href="/#plans" className="hidden hover:text-real-blue sm:inline">
            Plans
          </a>
          <a href="/#faq" className="hidden hover:text-real-blue sm:inline">
            FAQ
          </a>
          ...
          {session ? (
            <a
              href="/account"
              className="flex items-center gap-2 rounded-full border border-smooth-black/15 py-1 pl-1 pr-3 transition-colors hover:border-smooth-black/40"
            >
            ...
            <a
              ...
              className="hidden hover:text-real-blue sm:inline"
            >
              Sign in
            </a>
          )}
