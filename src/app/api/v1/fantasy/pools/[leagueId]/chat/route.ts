...
/** Open the pool's member-gated group chat. Returns it as a channel. (Pools
 *  share the Sleeper league id, so this reuses the same membership path.) */
export async function POST(
  ...
  try {
    ...
    return jsonError("internal", "Could not open pool chat.");
  }
}
