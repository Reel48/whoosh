    ...
    <>
      ...
      <main className="flex flex-1 flex-col items-center justify-center bg-lime px-6 py-24 text-center text-ink">
        <Image
          ...
          priority
        />
        <div className="mt-10 flex h-20 w-20 items-center justify-center rounded-full border-2 border-ink bg-mango">
          <Bolt className="h-10 w-10 text-ink" />
        </div>
        ...
        <a
          ...
          className="mt-9 inline-flex items-center justify-center gap-2 rounded-full border-2 border-ink bg-ink px-7 py-3.5 text-base font-bold text-white-smoke transition-colors hover:bg-blue"
        >
          <Bolt className="h-5 w-5" /> Open Discord
        </a>
        <a
          href="/account"
          className="mt-4 text-sm font-bold text-ink underline underline-offset-4 hover:text-imperial-red"
        >
          View your account
        </a>
      </main>
