...
export const OPERATIONS: ApiOperation[] = [
  ...
  {
    method: "get",
    path: "/api/v1/chat/starboard/deck",
    capability: "chat",
    operationId: "getStarboardDeck",
    summary: "Starboard-eligible messages the viewer hasn't swiped (Boost/Meh deck).",
    auth: "bearer",
    responseType: "StarboardDeckResponse",
  },
  {
    method: "get",
    path: "/api/v1/chat/starboard/leaderboard",
    capability: "chat",
    operationId: "getStarboardLeaderboard",
    summary: "All-time top messages by boosts.",
    auth: "bearer",
    responseType: "StarboardLeaderboardResponse",
  },
  {
    method: "post",
    path: "/api/v1/chat/starboard/boost",
    capability: "chat",
    operationId: "recordStarboardBoost",
    summary: "Boost/Meh a message (null direction undoes); returns new boost count.",
    auth: "bearer",
    requestType: "StarboardBoostRequest",
    responseType: "StarboardBoostResponse",
    extraErrors: ["forbidden", "not_found"],
  },
  {
    method: "get",
